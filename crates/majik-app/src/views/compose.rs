...
impl ComposeView {
    ...
    fn capsule(id: &'static str, icon_name: &'static str, label: impl Into<SharedString>, tooltip: &'static str) -> Chip {
...
impl Render for ComposeView {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let provider_button = Self::capsule("provider", "globe", self.state.provider.display_name, "Provider")

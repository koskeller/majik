...
//! [`settings`] the separate window, [`onboarding`] the first-launch flow, and the pickers are the
//! popovers they open. Each is an `Entity<T: Render>` that observes the library and rebuilds its own
